...
- Pure HTML5
- CSS3 (Custom design systeem)
- Vanilla JavaScript
- Responsive design
- Geen externe frameworks
...
├── styles.css          # Styling
├── scripts.js          # Interacties en animaties
└── README.md          # Deze file
```
...
Geen build proces of installatie nodig.

## Deployment

Deze website kan gehost worden op:
- GitHub Pages
- Netlify
- Vercel
- Elk statisch hosting platform
